...
#define BATT_LOW				43		/* 3.254V */		//112	/* 3.355V */
#define BATT_CRITICAL			8		/* 3.1029V */ 	//(74)	/* 3.15V */
#define BATT_MINIMUM			(-28)	/* 3.0029V */		//(38)	/* 3.05V */
#define BATT_OFF				(-128)	/* 3.0000V */		//(-103)	/* 3.00V  */
...
const int temper_table[][2] =  {
	...
	{ 1559,		0	},
	{ 1536,		10	},
#else //js43.choi H/W 요청에 의해서 table값 변경
	{ 1570,		-20	},
	{ 1544,		-10	},
	{ 1524,		0	},
	{ 1518,		10	},
