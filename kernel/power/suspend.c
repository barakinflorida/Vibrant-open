...
int enter_state(suspend_state_t state)
{
	...
	if(is_userspace_gov())
	{
		...
		s5pc110_lock_dvfs_high_level(DVFS_LOCK_TOKEN_7, LEV_100MHZ);
		gbClockFix = true;
		...
		cpufreq_driver_target(&policy, 100000, CPUFREQ_RELATION_L);
	}
	
#else
//	cpufreq_direct_set_policy(0, "userspace");
//	cpufreq_direct_store_scaling_setspeed(0, "100000", 0);
#endif
#endif
